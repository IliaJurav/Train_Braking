# -*- coding: utf-8 -*-
"""
Created on Wed May 29 16:55:13 2024
    ...
    def __init__(self, cnx, parent=0,):
        ...
        # +++++++++++++++
            ...
            def sel_loko(event):
                ...
                loko_axles.set(df.at[idx,'axles'])#df.at[idx,'axles'])
            ...
            fr2.pack(fill = 'x')
            fr_but = ttk.Frame(frLoko,borderwidth=1, relief='solid',style='Fr1.TFrame')# padding=[8, 10],
        ...
        def createPanelVagon():
            ...
            # for idx in range(dfv.shape[0]):
            #     trVagon.insert("", "end", values=[f"{idx+1}",dfv.at[idx,'name']],
        ...
        # +++++++++++++++
            ...
            def sel_vagon(event):
                ...
                #vag_massa.set(df.at[idx,'weight'])
                #vag_axes.set(df.at[idx,'axles'])#df.at[idx,'axles'])
